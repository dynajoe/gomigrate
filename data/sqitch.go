...
// MakeSqitchRegistrySQL the DDL to deploy sqitch registry tables
func MakeSqitchRegistrySQL(registry string) string {
	replacer := strings.NewReplacer(":tableopts", "", ":\"registry\"", registry)
